...
//         String sql = "INSERT INTO products (name, price, supplier_id, category, quantity) VALUES (?, ?, ?, ?, ?)";
...
//         String sql = "UPDATE products SET name = ?, price = ?, supplier_id = ?, category = ?, quantity = ? WHERE id = ?";
